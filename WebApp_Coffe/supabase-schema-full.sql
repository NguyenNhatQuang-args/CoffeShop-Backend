...
UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-04-07T00:00:00Z'
WHERE "Id" = '11111111-1111-1111-1111-111111111111';
...
UPDATE "Products" SET "CreatedAt" = TIMESTAMPTZ '2026-04-07T00:00:00Z'
WHERE "Id" = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa10';
...
UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2026-04-07T00:00:00Z', "RefreshToken" = NULL, "RefreshTokenExpiryTime" = NULL
WHERE "Id" = '99999999-9999-9999-9999-999999999999';

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260408141314_AddRefreshTokenToUser', '10.0.5');
